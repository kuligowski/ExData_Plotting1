...
with(data, {
  ...
  legend("topright",                          legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),         col = c("black", "red", "blue"),   lty = 1,   pch = NA,   yjust = 1) 
  
  plot(x = data$DateTime, y = data$Voltage,  col = "black", type = "l", xlab = "", xaxt = "n", xlab = "datetime", ylab = "Voltage")
  
  lines(x = data$DateTime,  y = data$Voltage,   col = "black",  type = "l")
  ...
  plot(x = data$DateTime, y = data$Global_reactive_power,  col = "black", type = "l", xlab = "", xaxt = "n", xlab = "datetime", ylab = "Global_reactive_power")
  
  lines(x = data$DateTime,  y = data$Global_reactive_power,   col = "black",  type = "l")
